    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('managed_groups', models.ManyToManyField(related_name='managers', to='medarbetarapp.employeegroup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_groups', models.ManyToManyField(related_name='published_surveys', to='medarbetarapp.employeegroup')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='medarbetarapp.question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('employee_groups', models.ManyToManyField(related_name='survey_templates', to='medarbetarapp.employeegroup')),
            ],
        ),
    ]
