    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_groups', models.ManyToManyField(related_name='group', to='medarbetarapp.employeegroup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_question', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='medarbetarapp.textquestion')),
                ('yes_no_question', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='medarbetarapp.yesnoquestion')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('free_text_answer', models.CharField(blank=True, max_length=255, null=True)),
                ('multiple_choice_answer', models.JSONField(blank=True, default=list, null=True)),
                ('yes_no_answer', models.BooleanField(blank=True, default=False, null=True)),
                ('slider_answer', models.FloatField(blank=True, null=True)),
                ...
                ('survey', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='medarbetarapp.surveyuserresult')),
            ],
        ),
    ]
